...
namespace CRM_wJames.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserID,UserFirstName,UserLastName,Username,UserPassword,UserTypeID")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserID,UserFirstName,UserLastName,Username,UserPassword,UserTypeID")] User user)
        {
            if (ModelState.IsValid)
            {
